...
int main(){
    ...
    */
    ...
    auto loss = torch::nll_loss(torch::log_softmax(input, 1), target);
    cout<<torch::log_softmax(input, 1)<<endl;
    cout<<loss;
    */
    torch::nn::EmbeddingBag *embtable;
    embtable[0] = emb;
    cout<<emb(t2)<<endl;
    cout<<embtable[0](t2)<<endl;
